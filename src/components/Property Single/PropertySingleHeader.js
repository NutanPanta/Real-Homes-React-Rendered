...
export default class PropertySingle extends Component {
  ...
  render() {
    return (
      <header className="propertySingleheader">
        <div className="container">
          <nav className="propertySinglenav">
            ...
            <div className="list">
              <ul>
                ...
                <li>
                  <Link to="/property" className="active-nav">
                    Property
                  </Link>
                </li>
                <li>
                ...
                <nav className="side_nav-list">
                  ...
                  <div className="side_nav-list">
                    <ul>
                      ...
                      <li className="side_nav-property active-side_nav">
                        <Link to="/property">Property</Link>
                      </li>
                      <li className="side_nav-agents">
                        <Link to="/agents">Agents</Link>
                      </li>
