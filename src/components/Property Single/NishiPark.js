          ...
          <div className="container">
            <div className="property-topic">
              <div className="property-name">
                <h2>245 Azabu Nishi Park let</h2>
                <p>Azabu Nishi, Miami, FL 33135, USA</p>
              ...
              <div className="content-left">
                <div className="property-background">
                  ...
                  <div className="property-description">
                    <h3>Description</h3>
                    <p>
                      Bright & Spacious, Top Floor/Corner Suite next to James
                      Bay is sure to please. Generously sized, the floor plan
                      has been beautifully adapted to modern life. Spacious
                      kitchen and living areas, 3 beds and 3 bathrooms all
                      renovated to the highest standards. A light and bright
                      easy care home with a south east exposure in a fantastic
                      location. Many upgrades in this large home, wood floors
                      and French doors leading to a private balcony. It is
                      ideally situated on a very private lot along a whisper
                      quiet street. The gentle slopped driveway leads up to your
                      hilltop building site offering secure views without much
                      site preparation. double car garage, concrete tile roof,
                      spacious rooms, large commercial grade low E windows and
                      security system sound and vac roughed in = peaceful suite
                      potential. A great family home or holding property.
                    </p>
                  </div>
                  <div className="additional-description">
                    ...
                    <p>
                      <strong> EXTERIOR CONSTRUCTION:</strong> Cement
                    </p>
                    <p>
